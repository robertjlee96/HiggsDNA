...
# name of the nominal events (relevant when we have multiple sets of events corresponding to systematics with independent collections)
NOMINAL_TAG = "nominal"
...
CONDOR_EXE_TEMPLATE_LXPLUS = (
    "higgs_dna/job_management/condor/executable_template_lxplus.sh"
)
CONDOR_SUB_TEMPLATE_LXPLUS = (
    "higgs_dna/job_management/condor/condor_submit_template_lxplus.txt"
)
