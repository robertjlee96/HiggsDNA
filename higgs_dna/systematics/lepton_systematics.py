...
DUMMY_LEPTON_SFs = {
    ...
    "bins": [
        ...
        {
            "lepton_pt": [50.0, 999999.0],
            "lepton_eta": [0.0, 999999.0],
            "value": 0.5,
            "uncertainty": 0.25,
        },
    ],
...
def dummy_lepton_sf(events, central_only, input_collection):
    ...
    """
    required_fields = [(input_collection, "pt"), (input_collection, "eta")]
    ...
    variations = systematic_from_bins(
        ...
        variables={"lepton_pt": leptons.pt, "lepton_eta": leptons.eta},
