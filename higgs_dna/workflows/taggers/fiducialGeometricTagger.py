...
class fiducialGeometricTagger:
    def __init__(self) -> None:
        pass

    @property
    def name(self) -> str:
        return "fiducialGeometricTagger"
    ...
    def __call__(self, events: ak.Array, diphotons: ak.Array) -> ak.Array:
        ...
        if 'GenIsolatedPhoton' in events.fields:  # if we are processind MC
            ...
            logger.debug(
                ...
                sqrt_product_scaled_pt: \t {ak.sum(selection.all("sqrt_product_scaled_pt"))}
            ...
            logger.debug("Processing data and you want the fiducialGeometricTagger. Thus, code of -99 is applied for all events in data.")
            return (
