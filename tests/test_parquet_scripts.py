...
def test_merge_parquet_and_convert():
    ...
    x = os.system("python ./scripts/merge_parquet.py --source ./tests/samples/parquet_files/singles/ --target ./tests/samples/parquet_files/merged/ --cats test_cat.json --skip-normalisation")  
